...
struct TaskInfo_
{
  ...
  using _record_rosbag2_type =
    bool;
  _record_rosbag2_type record_rosbag2;
  ...
  Type & set__record_rosbag2(
    const bool & _arg)
  {
    this->record_rosbag2 = _arg;
    return *this;
  }
  ...
  bool operator==(const TaskInfo_ & other) const
  {
    ...
    if (this->record_rosbag2 != other.record_rosbag2) {
      return false;
    }
    return true;
  }
