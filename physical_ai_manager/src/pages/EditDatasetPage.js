...
export default function EditDatasetPage() {
  ...
  // Huggingface related states moved to HuggingfaceSection component
  ...
  const handlers = {
    ...
    // Huggingface handlers moved to HuggingfaceSection component
  };

  // Token related handlers moved to HuggingfaceSection component

  // Button variants helper function moved to HuggingfaceSection component
  ...
  const operations = {
    ...
    // Huggingface operations moved to HuggingfaceSection component
  };
  ...
  return (
    <div className={STYLES.container}>
      ...
      {/* Huggingface related modals moved to HuggingfaceSection component */}
    </div>
  );
}
