...
#ifndef PHYSICAL_AI_INTERFACES__MSG__DETAIL__TRAINING_STATUS__TYPE_SUPPORT_H_
#define PHYSICAL_AI_INTERFACES__MSG__DETAIL__TRAINING_STATUS__TYPE_SUPPORT_H_
...
#endif  // PHYSICAL_AI_INTERFACES__MSG__DETAIL__TRAINING_STATUS__TYPE_SUPPORT_H_
