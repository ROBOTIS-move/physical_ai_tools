...
class Init_TaskInfo_record_rosbag2
{
public:
  explicit Init_TaskInfo_record_rosbag2(::physical_ai_interfaces::msg::TaskInfo & msg)
  : msg_(msg)
  {}
  ::physical_ai_interfaces::msg::TaskInfo record_rosbag2(::physical_ai_interfaces::msg::TaskInfo::_record_rosbag2_type arg)
  {
    msg_.record_rosbag2 = std::move(arg);
...
public:
  ...
  : msg_(msg)
  {}
  Init_TaskInfo_record_rosbag2 record_inference_mode(::physical_ai_interfaces::msg::TaskInfo::_record_inference_mode_type arg)
  {
    msg_.record_inference_mode = std::move(arg);
    return Init_TaskInfo_record_rosbag2(msg_);
  }
