...
static rosidl_typesupport_introspection_c__MessageMember physical_ai_interfaces__msg__TaskInfo__rosidl_typesupport_introspection_c__TaskInfo_message_member_array[16] = {
  {
    "task_name",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(physical_ai_interfaces__msg__TaskInfo, record_rosbag2),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
