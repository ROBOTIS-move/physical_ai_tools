...
class Init_GetTrainingInfo_Request_train_config_path
{
public:
  Init_GetTrainingInfo_Request_train_config_path()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  ::physical_ai_interfaces::srv::GetTrainingInfo_Request train_config_path(::physical_ai_interfaces::srv::GetTrainingInfo_Request::_train_config_path_type arg)
  {
    msg_.train_config_path = std::move(arg);
...
{
  return physical_ai_interfaces::srv::builder::Init_GetTrainingInfo_Request_train_config_path();
}
